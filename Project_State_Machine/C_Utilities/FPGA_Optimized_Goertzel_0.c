// Optimized Goertzel for FPGA MAC
#include <stdio.h>
#include <math.h>
#include <malloc.h>
#include <inttypes.h>
...
*/
    ...
    printf("Power:\t%4X\n", (uint16_t)res);
/*
    // Bin 123 @ 120k, for 120k sense
    printf("\nConst Bin @ 120k:\n");
    res = goertzel_mag(sample_buffer, sin_lut, 123);
    printf("Power:\t%4X\n", (uint16_t)res);
*/
    free(sample_buffer);
    free(sin_lut);
